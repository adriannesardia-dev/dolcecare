...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-floating-custom .form-control:focus ~ .input-icon { color: #6366f1; }
                    ...
                    <div class="auth-card">
                        <div class="card-body">
                            <div class="text-center animate-in">
                                ...
                                <p class="auth-subtitle">Join <span class="brand-gradient-text">DOLCECARE</span> today</p>
                            </div>

                            <form id="registerForm" class="animate-in delay-1">
                                @csrf
                                ...
                                <button type="submit" class="btn-auth mt-3" id="registerBtn">
                                    <span id="registerBtnText">Create Account</span>
                                    <span id="registerBtnSpinner" class="spinner-border spinner-border-sm d-none"></span>
                                </button>
                            </form>
