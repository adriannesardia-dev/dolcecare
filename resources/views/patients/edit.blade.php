        ...
        <form id="patientForm">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="first_name" name="first_name" value="{{ $patient->first_name }}" required autofocus>
...
<script>
    document.getElementById('patientForm').addEventListener('submit', async function (e) {
        ...
        try {
            const res = await fetch('{{ route("patients.update", $patient->id) }}', {
                method: 'POST',
        ...
        btn.disabled = false;
        btn.innerHTML = '<i class="bi bi-check-lg"></i> Update Patient';
    });
</script>
@endpush
